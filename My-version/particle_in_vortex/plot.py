...
data = np.loadtxt('rk4.dat', skiprows=0)
data1 = np.loadtxt('euler8.dat', skiprows=0)
data2 = np.loadtxt('euler6.dat', skiprows=0)
...
plt.plot(x, y,'k-', clip_on=False, label = 'rk4 advection')
plt.plot(x1, y1,'r-', clip_on=False, label = 'Euler 8 advection')
plt.plot(x2, y2,'b-', clip_on=False, label = 'Euler 6 advection')
